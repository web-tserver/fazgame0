...
// Updated: All components start unselected (RM0 total), WhatsApp marks unselected items,
// Added many older/used CPUs & GPUs based on Malaysia market
...
(function() {
  const componentData = {
    cpu: {
      label: "💻 CPU / Processor",
      items: [
        // Placeholder "None" option - starts unselected
        { name: "None (Not selected)", price: 0, selected: true },
        // Intel - New & Used (Malaysia market)
        ...
        // Older Intel (common in Malaysia used market)
    ...
    cooler: {
      ...
      items: [
        { name: "None (Not selected)", price: 0, selected: true },
        { name: "Stock Cooler (included)", price: 0 },
        { name: "Air Cooler (Budget - e.g. ID-Cooling)", price: 120 },
    ...
    gpu: {
      ...
      items: [
        ...
        // Old / Budget GPUs (Malaysia used market)
        ...
        { name: "GTX 1660 6GB (Used)", price: 500 },
        ...
        { name: "AMD RX 5700 8GB (Used)", price: 600 },
    ...
    assembly: {
      ...
      items: [
        { name: "None (Not selected)", price: 0, selected: true },
        { name: "Free Assembly & Testing", price: 0 },
  ...
  function requestQuote() {
    ...
    for (const [key, category] of Object.entries(componentData)) {
      ...
      if (select) {
        ...
        // Check if this is a "None (Not selected)" option
        if (optionText.includes("None (Not selected)")) {
